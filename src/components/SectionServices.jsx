    ...
    <section id="Services" className="container-fluid py-5">
      ...
      <div className="row justify-content-around">
        ...
        <div className="col-12 col-lg-7 my-auto">
          <h4 className="text-start">Descrubre lo que ofrecemos</h4><br></br>
          <p className="text-white"><strong>Para tu Salud</strong></p>
          <p className="text-white">
            Enfocados en tu bienestar integral, ofrecemos terapias que mejoran tu salud y calidad de vida. 
            Disfruta de nuestros servicios de acupuntura, auriculoterapia, conoterapia y rehabilitación, diseñados para equilibrar tu cuerpo y mente.
          </p>
          <p className="text-white"><strong>Para Consentirte</strong></p>
          <p className="text-white">
            Dedica un momento para ti y relájate con nuestros masajes. Cada sesión está pensada 
            para aliviar el estrés y revitalizar tu energía, ofreciéndote una experiencia de total bienestar.
          </p>
          <p className="text-white"><strong>Belleza</strong></p>
          <p className="text-white">
            Realza tu belleza natural con nuestros tratamientos especializados. 
            Desde limpiezas faciales profundas hasta extensiones de pestañas, te ayudamos a lucir y sentirte espectacular.
          </p>
        </div>
      </div>
    </section>
